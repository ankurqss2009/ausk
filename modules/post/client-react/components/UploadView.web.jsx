...
const UploadView = ({ values:{pictures}, handleUploadFiles, handleRemoveFile, t }) => {
    const columns = [
        {
    ...
    return (
        <div className="text-center">
            <Row>
                <Col xs={4}>
                    <Dropzone onDrop={handleUploadFiles} style={{borderRadius:"0",border:"none", borderRight:"1px solid #ccc", minHeight:"200px", height:"100%", display: "flex"}}>
                        <p className="text-primary" style={{alignSelf: "center"}}> {t('message')}</p>
                    </Dropzone>
                </Col>
                <Col xs={8}>
