...
import {Form, RenderField, Button, Col, Alert, Table, Row} from '@gqlapp/look-client-react';
...
const PostForm = (props) => {
    ...
    return (
        <Form name="post" onSubmit={handleSubmit}>
            <Row>
                <Col xs={12}><Field name="title" component={RenderField} type="text" label={t('post.field.title')} value={values.title}/></Col>
            </Row>
            <Row>
            ...
            <Row style={{marginBottom:10}}>
                <Col xs={4}>
                    <div className="textWrap" style={{minHeight:"240px"}}>
                        <div>
                            <Field
